...
$query = mysqli_query($koneksi, "
    SELECT tb_pemasangan.*, tb_paket.nama_paket, tb_paket.kecepatan, tb_paket.harga 
    FROM tb_pemasangan 
    LEFT JOIN tb_paket ON tb_pemasangan.id_paket = tb_paket.id_paket 
...
if (isset($_POST['submit'])) {
    ...
    move_uploaded_file($tmp, '../../assets/uploads/bukti/' . $nama_bukti);
    ...
    echo "<script>alert('Pembayaran berhasil dikirim'); window.location='../index.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="id">
        ...
        <div class="payment-merge-card">
            <div class="payment-left">
                ...
                <div class="payment-summary-list">
                    ...
                    <div class="payment-summary-item">
                        ...
                        <strong class="payment-price">Rp <?= number_format($data['harga']); ?></strong>
                    </div>
                    <div class="payment-summary-item">
                        <span>Status</span>
            ...
            <div class="payment-right">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="submit" class="btn-payment">
                        <i class="bi bi-check-circle-fill"></i> Kirim Pembayaran
                    </button>
                </form>
            </div>
        </div>
