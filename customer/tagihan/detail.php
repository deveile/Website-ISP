...
$query = mysqli_query($koneksi, "
    SELECT tb_transaksi.*, tb_customer.nama_customer, tb_customer.email_customer, 
           tb_customer.telepon_customer, tb_customer.alamat_customer, 
           tb_paket.nama_paket, tb_paket.kecepatan, tb_paket.harga 
    FROM tb_transaksi 
...
<div class="dashboard-layout">
    ...
    <div class="dashboard-content">
        ...
        <div class="detail-form-container">
            <div class="detail-section-title"><i class="bi bi-person-circle" style="color: #ff6b00;"></i> Data Transaksi</div>
            <div class="form-grid-2">
                <div class="form-field"><label>Nama Pelanggan</label><div class="value-box"><?= $data['nama_customer'] ?? '-'; ?></div></div>
                <div class="form-field"><label>Nomor Telepon / WhatsApp</label><div class="value-box"><?= $data['telepon_customer'] ?? '-'; ?></div></div>
                <div class="form-field"><label>Alamat Email</label><div class="value-box"><?= $data['email_customer'] ?? '-'; ?></div></div>
                <div class="form-field"><label>Alamat Pemasangan</label><div class="value-box"><?= $data['alamat_customer'] ?? '-'; ?></div></div>
            </div>

            <div class="detail-section-title"><i class="bi bi-wifi" style="color: #ff6b00;"></i> Paket & Status Tagihan</div>
            <div class="form-grid-2">
                <div class="form-field"><label>Produk / Paket Internet</label><div class="value-box"><?= $data['nama_paket'] ?? '-'; ?> (<?= $data['kecepatan'] ?? '-'; ?>)</div></div>
                <div class="form-field"><label>Periode Penggunaan</label><div class="value-box">Bulan <?= $data['bulan_tagihan']; ?> / Tahun <?= $data['tahun_tagihan']; ?></div></div>
                <div class="form-field"><label>Total Nominal Tagihan</label><div class="value-box" style="color: #ff6b00; font-weight: 700;">Rp <?= number_format($data['jumlah_bayar']); ?></div></div>
            ...
            <div class="detail-section-title"><i class="bi bi-image" style="color: #ff6b00;"></i> Lampiran Bukti Pembayaran</div>
            <div class="form-field">
                <div class="bukti-container">
                    <?php if (!empty($data['bukti_pembayaran'])) : ?>
                        <p style="margin-bottom: 12px; color: #555;"><i class="bi bi-info-circle"></i> Berikut adalah foto struk/bukti pembayaran yang dikirimkan :</p>
