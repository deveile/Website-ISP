...
if (isset($_POST['submit'])) {
    ...
    $nama     = mysqli_real_escape_string($koneksi, trim($_POST['nama_teknisi']));
    $username = mysqli_real_escape_string($koneksi, trim($_POST['username']));
    $telepon  = mysqli_real_escape_string($koneksi, trim($_POST['telepon_teknisi']));
    $password = $_POST['password'];

    if (empty($nama) || empty($username) || empty($password) || empty($telepon)) {
        ...
        if (mysqli_num_rows($cek) > 0) {
            ...
            // Memulai transaksi agar data tb_user dan tb_teknisi sinkron
            mysqli_begin_transaction($koneksi);

            $ok1 = mysqli_query($koneksi,
                "INSERT INTO tb_user (username, password, role)
                 VALUES ('$username', '$hash', 'teknisi')"
            );
            $id_user = mysqli_insert_id($koneksi);

            $ok2 = mysqli_query($koneksi,
                "INSERT INTO tb_teknisi (id_user, nama_teknisi, telepon_teknisi)
                 VALUES ('$id_user', '$nama', '$telepon')"
            );

            if ($ok1 && $ok2) {
                mysqli_commit($koneksi);
                $success = "Teknisi '$nama' berhasil ditambahkan.";
            } else {
...
// Menghitung Notifikasi seperti file lamamu
...
<div class="dashboard-layout">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="index.php" class="active"><i class="bi bi-person-plus"></i> <span>Kelola Teknisi</span></a></li>
    ...
    <div class="dashboard-content">
        ...
        <div class="topbar">
            ...
            <div>
                ...
                <p>Tambahkan akun teknisi lapangan baru</p>
            </div>
        </div>
        ...
        <div class="form-wrapper-admin">
            <form method="POST" class="form-admin-card">
                ...
                <div class="form-admin-header">
                    <h2>Form Teknisi</h2>
                    <a href="list_teknisi.php" class="btn-ke-daftar">
                        <i class="bi bi-list-ul"></i> List Teknisi
                    </a>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telepon_teknisi"
                           placeholder="Contoh: 081234567890"
                           value="<?= htmlspecialchars($_POST['telepon_teknisi'] ?? '') ?>"
                           required>
                </div>
