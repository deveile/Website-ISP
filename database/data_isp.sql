...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2026 at 04:55 PM
...
CREATE TABLE `tb_langganan` (
  ...
  `status_langganan` enum('aktif','suspend','berhenti') DEFAULT 'aktif'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tb_langganan`
  MODIFY `id_langganan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
