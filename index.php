<?php
include 'koneksi.php';
$paket = mysqli_query($koneksi, "SELECT * FROM tb_paket where status='aktif' ORDER BY id_paket DESC LIMIT 3");
?>
<!DOCTYPE html>
<html lang="id">
<head>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-text">
                        ...
                        <p>Internet fiber optic cepat, stabil, dan terjangkau untuk kebutuhan rumah dan bisnis di Kabupaten Subang.</p>
                    ...
                    <?php while ($data = mysqli_fetch_assoc($paket)) { ?>
                        <div class="col-lg-4">
                            <div class="paket-card">
                                ...
                                <span><?php echo nl2br($data['deskripsi']); ?></span><br>
